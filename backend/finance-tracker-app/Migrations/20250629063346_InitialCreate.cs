...
namespace finance_tracker_app.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "RecurringTransactionAttachments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecurringTransactionAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecurringTransactionAttachments_RecurringTransactions_RecurringTransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecurringTransactionAttachments_RecurringTransactionId",
                table: "RecurringTransactionAttachments",
